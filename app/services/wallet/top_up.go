...
func (s *walletService) TopUp(c context.Context, walletId string, req *presentation.TransactionTopUpRequest) (*presentation.WalletActionConfirmation, error) {
	...
	transaction := entity.Transaction{
		WalletID: wallet.ID,
		Amount: amountMinor,
		TransactionType: string(entity.TransactionTypeTopUp),
